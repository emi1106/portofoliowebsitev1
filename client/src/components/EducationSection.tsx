          ...
          <div className="relative">
            ...
            <div className="relative z-10">
              <div className="flex items-center mb-6">
                <div className="flex-shrink-0 w-12 h-12 flex items-center justify-center bg-primary-600 dark:bg-blue-600 rounded-full text-white shadow-lg">
                  <GraduationCap className="h-6 w-6" />
                </div>
                <div className="ml-6 bg-white dark:bg-gray-800 p-6 rounded-lg shadow-md hover:shadow-lg transition-shadow w-full md:w-[calc(100%-3rem)]">
                  ...
                  <div className="flex flex-wrap gap-2">
                    <span className="inline-flex items-center px-3 py-1 rounded-full text-xs font-medium bg-primary-100 dark:bg-blue-900/30 text-primary-800 dark:text-blue-300">
                      Algorithms
                    </span>
                    <span className="inline-flex items-center px-3 py-1 rounded-full text-xs font-medium bg-primary-100 dark:bg-blue-900/30 text-primary-800 dark:text-blue-300">
                      Data Structures
